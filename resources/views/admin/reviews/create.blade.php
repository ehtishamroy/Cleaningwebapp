    ...
    <div class="card-body">
        <form method="POST" action="{{route('admin.review.store')}}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('review') ? 'is-invalid' : '' }}" name="review" id="review" rows="3" required>{{ old('review') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="number" name="rating" id="rating" value="{{ old('rating') }}" min="1" max="5" required>
